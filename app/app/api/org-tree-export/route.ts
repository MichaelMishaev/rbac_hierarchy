  ...
  try {
    ...
    areaManagers.forEach((area) => {
      ...
      hierarchyData.push({
        ...
        'מנהל אזור': area.user.fullName,
        'אימייל מנהל': area.user.email,
        'טלפון מנהל': area.user.phone,
        'עיר': '',
        'רכז עיר': '',
        'רכז פעילים': '',
        'שכונה': '',
      ...
      area.cities.forEach((city) => {
        ...
        city.activistCoordinators.forEach((coord) => {
          hierarchyData.push({
            ...
            'עיר': city.name,
            'רכז עיר': '',
            'רכז פעילים': coord.user.fullName,
            'שכונה': '',
            'פעיל': '',
            'סה"כ ערים': '',
            'סה"כ שכונות': '',
    ...
    const summaryData = areaManagers.map((area) => ({
      'מחוז': area.regionName,
      'מנהל אזור': area.user.fullName,
      'אימייל': area.user.email,
      'טלפון': area.user.phone,
